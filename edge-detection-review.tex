...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{results/molino.eps}
...
\begin{figure}[h!]
	\centering
	\subfloat[Roberts.]{\label{fig:result1-a}\includegraphics[width=0.5\textwidth]{results/molino.roberts.eps}}
	
	\subfloat[Prewitt.]{\label{fig:result1-b}\includegraphics[width=0.5\textwidth]{results/molino.prewitt.eps}}
	
	\subfloat[Sobel.]{\label{fig:result1-c}\includegraphics[width=0.5\textwidth]{results/molino.sobel.eps}}
...
%\begin{figure}[b!]
%	\centering
%	\subfloat[Roberts.]{\label{fig:result1-a}\includegraphics[width=0.3\textwidth]{results/square/square.roberts.eps}}
%	\quad
%	\subfloat[Prewitt.]{\label{fig:result1-b}\includegraphics[width=0.3\textwidth]{results/square/square.prewitt.eps}}
%	\quad
%	\subfloat[Sobel.]{\label{fig:result1-c}\includegraphics[width=0.3\textwidth]{results/square/square.sobel.eps}}

%	\subfloat[Marr-Hildreth (Gaussian).]{\label{fig:result1-a}\includegraphics[width=0.3\textwidth]{results/square/square.marr-hildreth.eps}}
%	\quad
%	\subfloat[Marr-Hildreth (LoG).]{\label{fig:result1-b}\includegraphics[width=0.3\textwidth]{results/square/square.marr-hildreth-log.eps}}
%	\quad
%	\subfloat[Haralick.]{\label{fig:result1-c}\includegraphics[width=0.3\textwidth]{results/square/square.haralick.eps}}
