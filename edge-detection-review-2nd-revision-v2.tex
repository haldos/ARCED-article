...
\href{http://dev.ipol.im/~haldos/ipol_demo/xxx_edges/}{online demonstration}\footnote{\url{http://dev.ipol.im/~haldos/ipol_demo/xxx_edges/}} is also available, where 
