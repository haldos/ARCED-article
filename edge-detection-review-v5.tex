...
Another observation is that edges detected by Haralick algorithm appear to be thicker than those detected with the other algorithms. This may be due the regularity that Haralick assumes, we mentioned 
before. \\
